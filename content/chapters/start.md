...
Подключите один `core.css` из CDN `latest`, затем штатную тему. Собственный CSS для этого мануала и его демонстраций не требуется. Проверяем неминифицированные файлы; для минифицированных вариантов зафиксированы SHA-256, но их семантическая эквивалентность отдельно не проверялась.
